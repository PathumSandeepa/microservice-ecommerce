...
const CartPage = () => {
   ...
   const [shippingForm, setShippingForm] =
      React.useState<ShippingFormInputs | null>(null);
               ...
               {activeStep === 1 ? (
                  cartItems.map((item) => (
                     ...
                     >
                        ...
                        {/* DELETE BUTTON  */}
                        <button className="w-8 h-8 rounded-full bg-red-100 text-red-400 flex items-center justify-center hover:text-red-700 transition-all duration-200 cursor-pointer">
            ...
            <div className="w-full lg:w-5/12 shadow-lg border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
               ...
               {activeStep === 1 && (
                  <button
                     ...
                     className="w-full bg-gray-800 hover:bg-gray-500 transition-all duration-200 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2"
                  >
                     Continue
